...
//-----------------------------------------------------------------------
//  Program includes two sequential versions of Matrix Multiplication
//-----------------------------------------------------------------------
#include <iostream>
#include <iomanip>
#include <cmath>
...
bool GetUserInput(int argc, char *argv[],int& n,int& version, int& isPrint)
{
	...
	else 
	{
		...
		if (argc >=4)
			isPrint = (atoi(argv[4])==1 && n <=10)?1:0;
		else
			isPrint = 0;
	}
	return isOK;
...
int main(int argc, char *argv[])
{
	...
	cout << "Execution time: " << elapsed_secs << " seconds" << std::endl;
